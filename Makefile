...
OBJS := timer.o alloc.o parameters.o random.o update.o multilevel.o plaquette.o polyakov.o tune.o cuda_error_check.o actime.o plaquette_comps.o chromofield.o multilevel_TTO.o convertOrder.o smearing.o wilsonloop.o
