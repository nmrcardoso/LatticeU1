...
OBJS := timer.o alloc.o parameters.o random.o update.o plaquette.o polyakov.o tune.o cuda_error_check.o actime.o plaquette_comps.o chromofield.o convertOrder.o smearing.o wilsonloop.o Fmunu.o multilevel.o   multilevel_TTO.o fields.o ../u1.o
