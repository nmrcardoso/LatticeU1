...
class TuneKey {
  ...
  protected:
    ...
    if (tuneGridDim()) {
      ...
      if(param.block.x > max_threads) errorU1("Local lattice volume is too large for device");
    }
